...
View all [artifacts]({{< relref "/guides/artifacts/" >}}) associated with a project, from training datasets and [fine-tuned models]({{< relref "/guides/registry/" >}}) to [tables of metrics and media]({{< relref "/guides/models/tables/tables-walkthrough.md" >}}).
