...
## Slack notifications
Configure Slack destinations where your team's [automations]({{< relref "/guides/automations/" >}}) can send notifications when an event occurs in a Registry or a project, such as when a new artifact is created or when a run metric meets a defined threshold. Refer to [Create a Slack automation]({{< relref "/guides/automations/create-automations/slack.md" >}}).
...
## Webhooks
Configure webhooks that your team's [automations]({{< relref "/guides/automations/" >}}) can run when an event occurs in a Registry or a project, such as when a new artifact is created or when a run metric meets a defined threshold. Refer to [Create a webhook automation]({{< relref "/guides/automations/create-automations/slack.md" >}}).
