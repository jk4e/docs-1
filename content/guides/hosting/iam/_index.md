...
Every project is comprised of [Workspaces]({{< relref "/guides/models/track/workspaces.md" >}}) and [Reports]({{< relref "/guides/reports/" >}}), and is linked to relevant [Artifacts]({{< relref "/guides/artifacts/" >}}), [Sweeps]({{< relref "/guides/models/sweeps/" >}}), and [Automations]({{< relref "/guides/automations/" >}}).
